      ...
      <div class="container-fluid">
        <div class="row">          
          <div class="col-sm-12 col-md-12">
            <h1 class="m-0 text-dark">{{$desc}}</h1>
          </div>    
        </div><!-- /.row -->
        <div class="col-md-12">
          <hr>
...
<input type="hidden" id="wotypenow" value="{{$desc}}"/>
</div>
...
<div class="table-responsive col-12">
    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        <thead>
            ...
            <th class="sorting" data-sorting_type="asc" data-column_name="wo_priority" style="cursor: pointer" width="10%">Aging</th>
            <th width="10%">Action</th>
            </tr>
        </thead>
        <tbody>
            <!-- untuk isi table -->                  
              @include('dash.table-wotype')
...
$(document).on('click', '.pagination a', function(event) {
    ...
    fetch_data(page, sort_type, column_name, wonumber,woasset,status,priority,period);
  });
  ...
  function fetch_data(page, sort_type, sort_by, wonumber,woasset, wostatus,wopriority,woperiod) {
    var urlnow = document.getElementById('wotypenow').value;
      // asset = urlnow.substring(urlnow.lastIndexOf('/')+1,urlnow.lastIndexOf('('))
    //   alert(urlnow);
    $.ajax({
      url: "/wotype/"+urlnow +"/pagination?page=" + page + "&sorttype=" + sort_type + "&sortby=" + sort_by + "&wonumber=" + wonumber + "&woasset=" + woasset + "&wostatus=" + wostatus + "&wopriority="+wopriority+"&woperiod="+woperiod,
  ...
  $(document).on('click', '#btnsearch', function() {
    // alert(document.getElementById('wotypenow').value);
