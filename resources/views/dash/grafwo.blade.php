...
<input type="hidden" id="deskripsi" value="{{$deskripsi}}"/>
    ...
    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        <thead>
            <tr>
                ...
                <th width="8%">Finish Date</th>
                <th width="7%">Action</th>
            </tr>
        </thead>
        <tbody>
            @include('dash.table-grafwo')
        </tbody>
    </table>
      ...
      <div class="modal-header">
        ...
        <div class="modal-body">
          <div class="form-group row justify-content-center">
            ...
            <div class="col-md-3">
              <input id="v_nowo" type="text" class="form-control" name="v_nowo"  readonly>
            </div>
            <label for="v_nosr" class="col-md-2 col-form-label text-md-right">SR Number</label>
            <div class="col-md-3">
              <input id="v_nosr" type="text" class="form-control" name="v_nosr"  readonly>
            </div>
          </div>
          <div class="form-group row justify-content-center">
            <label for="v_tipewo" class="col-md-2 col-form-label text-md-left">WO Type</label>
            <div class="col-md-8">
              <input type='text' id="v_tipewo" class="form-control v_tipewo" name="v_tipewo"  readonly>
            </div>
          </div>
          <div class="form-group row justify-content-center" id="vien1">
            ...
            <div class="col-md-8">
              <input type='text' id="v_engineer1" class="form-control v_engineer1" name="v_engineer1"  readonly>
            </div>
          </div>
          <div class="form-group row justify-content-center">
            <label for="v_asset" class="col-md-2 col-form-label text-md-left">Asset</label>
            <div class="col-md-8">
              <input type="text" readonly id="v_asset" type="text" class="form-control v_asset" name="v_asset" >
            </div>
          </div>
          <div class="form-group row justify-content-center" id="vdivfail1">
            ...
            <div class="col-md-8">
              <textarea id="v_failure1" class="form-control v_failure1" readonly></textarea>
          ...
          <div class="form-group row justify-content-center">
            <label for="v_finish" class="col-md-2 col-form-label text-md-left">Finish Date</label>
            <div class="col-md-3">
              <input id="v_finish" readonly type="text" class="form-control" name="v_finish"  >
            </div>
            <label for="v_hour" class="col-md-2 col-form-label text-md-right">Work Hour</label>
            <div class="col-md-3">
              <input id="v_hour" type="text" class="form-control" name="v_hour"  readonly>
            </div>
          </div>
          <div class="form-group row justify-content-center">
            <label for="v_dept" class="col-md-2 col-form-label text-md-left">Department</label>
            <div class="col-md-8">
              <input  id="v_dept" readonly  class="form-control" name="v_dept" >
            </div>
          </div>
          <div class="form-group row justify-content-center">
            ...
            <div class="col-md-3">
              <input id="v_priority" type="text" class="form-control" name="v_priority"  readonly>
            </div>
          </div>
          <div class="form-group row justify-content-center" id="divviewcode" style="display: none;">
            ...
            <div class="col-md-8">
              <textarea id="v_repaircode" readonly  class="form-control" name="v_repaircode" ></textarea>
            </div>
          </div>
          <div class="form-group row justify-content-center" id="divviewgroup" style="display: none;">
            ...
            <div class="col-md-8">
              <input  id="v_repairgroup" readonly  class="form-control" name="v_repairgroup" >
            </div>
          </div>
          <div class="form-group row justify-content-center">
            <label for="v_note" class="col-md-2 col-form-label text-md-left">Note</label>
            <div class="col-md-8">
              <textarea id="v_note" readonly  class="form-control" name="v_note"  ></textarea>
            </div>
          </div>
          <div class="form-group row justify-content-center" id="reportnote" style="display: none;">
            ...
            <div class="col-md-8">
            <textarea id="v_reportnote" class="form-control v_reportnote" name="v_reportnote" readonly></textarea>
            </div>
          </div>
          <div class="form-group row justify-content-center" id="divunconf" style="display: none;">
            ...
            <div class="col-md-8">
              <textarea id="v_unconfirm" readonly  class="form-control" name="v_unconfirm" ></textarea>
            </div>
          </div>
        </div>
...
<script>
    ...
    $(document).on('click', '.viewwo', function() {
      ...
      $.ajax({
        ...
        success:function(vamp){
          ...
          if (finish == null) {
            document.getElementById('v_finish').value    = '';
            document.getElementById('v_hour').value    = '';
          } else {
          ...
          if (tipewo == "auto") {
            document.getElementById('v_tipewo').value       = 'PM';
          } else {
            document.getElementById('v_tipewo').value       = 'WO';
          }
  ...
  function fetch_data(page, sort_type, sort_by, wonumber,woasset,wostatus,wocreatedate,tipewo) {
    ...
    $.ajax({
      url: "/datagrafwo/"+urlnow +"/pagination?page=" + page + "&sorttype=" + sort_type + "&sortby=" + sort_by + "&wonumber=" + wonumber + "&woasset=" + woasset + "&wostatus=" + wostatus + "&wocreatedate="+wocreatedate+"&tipewo="+tipewo,
      success: function(data) {
        console.log(data);
        $('tbody').html('');
        $('tbody').html(data);
  ...
  $(document).on('click', '#btnexcel', function() {
    ...
    window.open("/donlodwograf?wonumber=" + wonumber +"&asset="+woasset+"&status="+wostatus+"&wocreatedate="+wocreatedate+"&tipewo="+tipewo+"&deskripsi="+deskripsi,'_blank');
  });
</script>
@endsection