      ...
      <form class="form-horizontal" id="newedit" method="post" action="/reportingwo">
        ...
        <div class="form-group row col-md-12">
          ...
          <div class="col-md-12 p-0" id="divmanual" style="display: none;">
            <div class="form-group row col-md-12 divrepgroup" >
                <label for="manualcount" class="col-md-5 col-form-label text-md-left">Number of part repaired <span id="alert1" style="color: red; font-weight: 200;">*</span></label>
                <div class="col-md-7">
                  <input type="hidden" id="inputgroup1">
...
$(document).on('change','.sparepartnum',function(){
  ...
  // alert(thisid);
    ...
    if(intid != 0 && intid <11){
      ...
      col2 +='<table class="table table-borderless mt-4" id="dataTable" width="100%" style="border:2px solid" cellspacing="0">';
      col2 +='<thead>';
      col2 +='<tr style="text-align: center;style="border:2px solid"">';
      col2+='<th rowspan="2" style="border:2px solid;width:15%"><p style="height:100%">Sparepart</p></th>';
      col2+='<th rowspan="2" style="border:2px solid;width:30%"><p style="height:100%">Instruksi</p></th>';
      col2+='<th rowspan="2" style="border:2px solid;width:30%"><p style="height:100%">Standard</p></th>';
      col2+='<th rowspan="2" style="border:2px solid;width:5%"><p style="height:100%">Quantity</p></th>';
      col2+='<th rowspan="2" style="border:2px solid;width:10%"><p style="height:100%">Repair Hour</p></th>';
      col2+='<th colspan="2" style="border:2px solid;width:15%"><p style="height:100%">kondisi</p></th>';
      col2 +='</tr>';
      col2 +='<tr style="text-align: center;">';
      col2 +='<th style="border:2px solid">Baik</th>';
      col2 +='<th style="border:2px solid">Tidak</th>';
      col2 +='</tr>';
      col2 +='</thead>';
      ...
      for(var i = 0; i<intid; i++){
        ...
        col2+='<td style="margin-top:0;height:40px;border:2px solid"><input type="number" name="qtyspare'+substrthis+'[]" min=1 value=1 style="border:0px"></td>';
        col2+='<td style="margin-top:0;height:40px;border:2px solid"><input type="number" name="rphspare'+substrthis+'[]" min=1 value=1 style="border:0px"></td>';
        col2+='<td style="text-align:center;margin-top:0;border:2px solid"><input type="radio" name="groupspare'+substrthis+'['+i+']" id="itemspare'+i+'" value="y'+i+'"></td>';
        col2+='<td style="text-align:center;margin-top:0;border:2px solid"><input type="radio" name="groupspare'+substrthis+'['+i+']" id="itemspare'+i+'" value="n'+i+'"></td>'; 
        col2+='</tr>';
  ...
  $(document).on('change','#repaircode1',function(event){
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        col+='<thead>';
        col+='<tr style="text-align: center;style="border:2px solid"">';
        col+='<th rowspan="2" style="border:2px solid;width:15%"><p style="height:100%">Sparepart</p></th>';
        col+='<th rowspan="2" style="border:2px solid;width:30%"><p style="height:100%">Instruksi</p></th>';
        col+='<th rowspan="2" style="border:2px solid;width:30%"><p style="height:100%">Standard</p></th>';
        col+='<th rowspan="2" style="border:2px solid;width:5%"><p style="height:100%">Quantity</p></th>';
        col+='<th rowspan="2" style="border:2px solid;width:10%"><p style="height:100%">Repair Hour</p></th>';
        col+='<th colspan="2" style="border:2px solid;width:15%"><p style="height:100%">kondisi</p></th>';
        col+='</tr>';
        col+='<tr style="text-align: center;">';
        col+='<th style="border:2px solid">Baik</th>';
        col+='<th style="border:2px solid">Tidak</th>';
        ...
        for(i =0; i<len;i++){
          ...
          if(result[i].spm_desc == null){
            col+='<td style="margin-top:0;height:40px;border:2px solid"><p style="margin:0px;"><b>-</b></p></td>';
            col+='<input type="hidden" name="spm1[]" value='+null+'>';
          }
          else{
            col+='<td style="margin-top:0;height:40px;border:2px solid"><p style="margin:0px;"><b>'+result[i].spm_desc+'</b></p></td>';
          ...
          if(result[i].ins_check == null){
            col+='<td style="margin-top:0;height:40px;border:2px solid"><p style="margin:0px;"><b>-</b></p></td>';
            col+='<input type="hidden" name="std1[]" value='+null+'>';
          }
          else{
            col+='<td style="margin-top:0;height:40px;border:2px solid"><p style="margin:0px;"><b>'+result[i].ins_check+'</b></p></td>';
            col+='<input type="hidden" name="std1[]" value="'+result[i].ins_check+'">';
          }
          col+='<td style="margin-top:0;height:40px;border:2px solid"><input type="number" name="qty1[]" min=1 value=1 style="border:0px"></td>';
          col+='<td style="margin-top:0;height:40px;border:2px solid"><input type="number" name="rph1[]" min=1 value=1 style="border:0px"></td>';
          col+='<td style="text-align:center;margin-top:0;border:2px solid"><input type="radio" name="group1[group'+i+']" id="item'+i+'" value="y'+i+'"></td>';
          col+='<td style="text-align:center;margin-top:0;border:2px solid"><input type="radio" name="group1[group'+i+']" id="item'+i+'" value="n'+i+'"></td>';
          col+='</tr>';
        }
        ...
        col+='</div>';
        col +='<div class="form-group row col-md-12 divrepcode" >';
        col +='<label for="sparepartnum1" class="col-md-5 col-form-label text-md-left">Repair Code 1 Spareparts </label>';
        col +='<div class="col-md-7">';
        col +='<input id="sparepartnum1" type="number" class="form-control sparepartnum" name="sparepartnum1"  min ="1">';
        col +='</div>';
        col +='</div>';
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        for(i =0; i<len;i++){
          if(result[i].spm_desc == null){
            col+='<td style="margin-top:0;height:40px;border:2px solid"><p style="margin:0px;"><b>-</b></p></td>';
            col+='<input type="hidden" name="spm2[]" value='+null+'>';
          }
          else{
            col+='<td style="margin-top:0;height:40px;border:2px solid"><p style="margin:0px;"><b>'+result[i].spm_desc+'</b></p></td>';  
            ...
            if(result[i].ins_check == null){
              col+='<td style="margin-top:0;height:40px;border:2px solid"><p style="margin:0px;"><b>-</b></p></td>';
              col+='<input type="hidden" name="std2[]" value='+null+'>';
            }
            else{
              col+='<td style="margin-top:0;height:40px;border:2px solid"><p style="margin:0px;"><b>'+result[i].ins_check+'</b></p></td>';
              col+='<input type="hidden" name="std2[]" value="'+result[i].ins_check+'">';
            }
            col+='<td style="margin-top:0;height:40px;border:2px solid"><input type="number" name="qty2[]" min=0 value=1 style="border:0px"></td>';
            col+='<td style="margin-top:0;height:40px;border:2px solid"><input type="number" name="rph2[]" min=1 value=1 style="border:0px"></td>';
            col+='<td style="text-align:center;margin-top:0;border:2px solid"><input type="radio" name="group2[group'+i+']" id="item'+i+'" value="y'+i+'"></td>';
            col+='<td style="text-align:center;margin-top:0;border:2px solid"><input type="radio" name="group2[group'+i+']" id="item'+i+'" value="n'+i+'"></td>';
            col+='</tr>';
        }
        ...
        col+='</div>';
        col +='<div class="form-group row col-md-12 divrepcode" >';
        col +='<label for="sparepartnum2" class="col-md-5 col-form-label text-md-left">Repair Code 2 Spareparts </label>';
        col +='<div class="col-md-7">';
        col +='<input id="sparepartnum2" type="number" class="form-control sparepartnum" name="sparepartnum2"  min ="1">';
        col +='</div>';
        col +='</div>';
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        for(i =0; i<len;i++){
          ...
          if(result[i].spm_desc == null){
            col+='<td style="margin-top:0;height:40px;border:2px solid"><p style="margin:0px;"><b>-</b></p></td>';
            col+='<input type="hidden" name="spm3[]" value='+null+'>'; 
          }
          else{
            col+='<td style="margin-top:0;height:40px;border:2px solid"><p style="margin:0px;"><b>'+result[i].spm_desc+'</b></p></td>';  
            ...
            if(result[i].ins_check == null){
              col+='<td style="margin-top:0;height:40px;border:2px solid"><p style="margin:0px;"><b>-</b></p></td>';
            col+='<input type="hidden" name="std3[]" value='+null+'>'; 
            }
            else{
              col+='<td style="margin-top:0;height:40px;border:2px solid"><p style="margin:0px;"><b>'+result[i].ins_check+'</b></p></td>';
            col+='<input type="hidden" name="std3[]" value="'+result[i].ins_check+'">';
            }
            col+='<td style="margin-top:0;height:40px;border:2px solid"><input type="number" name="qty3[]" min=1 value=1 style="border:0px"></td>';
            col+='<td style="margin-top:0;height:40px;border:2px solid"><input type="number" name="rph3[]" min=1 value=1 style="border:0px"></td>';
            col+='<td style="text-align:center;margin-top:0;border:2px solid"><input type="radio" name="group3[group'+i+']" id="item'+i+'" value="y'+i+'"></td>';
            col+='<td style="text-align:center;margin-top:0;border:2px solid"><input type="radio" name="group3[group'+i+']" id="item'+i+'" value="n'+i+'"></td>';
            col+='</tr>';
        }
        ...
        col+='</div>';
        col +='<div class="form-group row col-md-12 divrepcode" >';
        col +='<label for="sparepartnum3" class="col-md-5 col-form-label text-md-left">Repair Code 3 Spareparts </label>';
        col +='<div class="col-md-7">';
        col +='<input id="sparepartnum3" type="number" class="form-control sparepartnum" name="sparepartnum3"  min ="1">';
        col +='</div>';
        col +='</div>';
  ...
  $(document).on('change','#manualcount',function(e){
    ...
    if(count1 != ''){
      ...
      for(var co = 0; co < count1; co++){
        col +='<tr>';
        col+='<td style="height: 20px;border:2px solid"><select id="part'+co+'" name="part[]" style="border:none;width:100%"><option value=null></option>';
        ...
        col+='<td style="height: 20px;border:2px solid"><select id="ins'+co+'" name="ins[]" style="border:none;width:100%"><option value=null></option>';
        ...
        col+='<td style="height: 20px;border:2px solid"><input type="text" name="desc[]" style="border:none;width:100%"></td>';
        col+='<td style="margin-top:0;height:40px;border:2px solid"><input type="number" name="qty5[qty'+co+']" min=1 value=1 style="border:0px"></td>';
        col+='<td style="margin-top:0;height:40px;border:2px solid"><input type="number" name="rph5[rph'+co+']" min=1 value=1 style="border:0px"></td>';
        col+='<td style="text-align:center;margin-top:0;border:2px solid"><input type="radio" name="group5['+co+']" id="item'+co+'" value="y'+co+'"></td>';
        col+='<td style="text-align:center;margin-top:0;border:2px solid"><input type="radio" name="group5['+co+']" id="item'+co+'" value="n'+co+'"></td>'; 
        col+='</tr>';
      }
        ...
        success: function(data) {
          ...
          if(len >0){
            for(p = 0; p<countrepair; p++){
              ...
              col+='<thead>';
              col+='<tr style="text-align: center;style="border:2px solid"">';
              col+='<th rowspan="2" style="border:2px solid;width:20%"><p style="height:100%">Sparepart</p></th>';
              col+='<th rowspan="2" style="border:2px solid;width:30%"><p style="height:100%">Instruksi</p></th>';
              col+='<th rowspan="2" style="border:2px solid;width:30%"><p style="height:100%">Standard</p></th>';
              col+='<th rowspan="2" style="border:2px solid;width:5%"><p style="height:100%">Quantity</p></th>';
              col+='<th rowspan="2" style="border:2px solid;width:5%"><p style="height:100%">Repair Hour</p></th>';
              col+='<th colspan="2" style="border:2px solid;width:15%"><p style="height:100%">kondisi</p></th>';
              col+='</tr>';
              col+='<tr style="text-align: center;">';
              col+='<th style="border:2px solid">Baik</th>';
              ...
              for(var i =0; i<len;i++){
                ...
                if(result[i].xxrepgroup_rep_code == temprepair[p]){
                      ...
                      if(result[i].spm_desc == null){
                        col+='<td style="margin-top:0;height:40px;border:2px solid"><p style="margin:0px;"><b>-</b></p></td>';
                        col+='<input type="hidden" name="spm4['+p+']['+counter+']" value='+null+'>'
                      }
                      else{
                        col+='<td style="margin-top:0;height:40px;border:2px solid"><p style="margin:0px;"><b>'+result[i].spm_desc+'</b></p></td>';
                      ...
                      if(result[i].ins_check == null){
                        col+='<td style="margin-top:0;height:40px;border:2px solid"><p style="margin:0px;"><b>-</b></p></td>';
                        col+='<input type="hidden" name="std4['+p+']['+counter+']" value='+null+'>'
                      }
                      else{
                        col+='<td style="margin-top:0;height:40px;border:2px solid"><p style="margin:0px;"><b>'+result[i].ins_check+'</b></p></td>';
                        col+='<input type="hidden" name="std4['+p+']['+counter+']" value="'+result[i].ins_check+'">'
                      }
                      col+='<td style="margin-top:0;height:40px;border:2px solid"><input type="number" name="qty4['+p+']['+counter+']" min=1 value=1 style="border:0px"></td>';
                      col+='<td style="margin-top:0;height:40px;border:2px solid"><input type="number" name="rph4['+p+']['+counter+']" min=1 value=1 style="border:0px"></td>';
                      col+='<td style="text-align:center;margin-top:0;border:2px solid"><input type="radio" name="group4['+p+']['+counter+']" id="item'+p+counter+'" value="y'+counter+'"></td>';
                      col+='<td style="text-align:center;margin-top:0;border:2px solid"><input type="radio" name="group4['+p+']['+counter+']" id="item'+p+counter+'" value="n'+counter+'"></td>';
                      col+='</tr>';
                      counter +=1;
                  ...
                  col+='</div>';
                  col +='<div class="form-group row col-md-12 divrepcode" >';
                  col +='<label for="sparepartnum'+(p+1)+'" class="col-md-5 col-form-label text-md-left">Repair Code '+(p+1)+' Spareparts </label>';
                  col +='<div class="col-md-7">';
                  col +='<input id="sparepartnum'+(p+1)+'" type="number" class="form-control sparepartnum" name="sparepartnum[]"  min ="1">';
                  col +='</div>';
                  col +='</div>';
