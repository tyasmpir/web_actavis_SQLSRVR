  ...
  <table class="table table-bordered mt-0" id="dataTable" width="100%" cellspacing="0" style="width:100%;padding: .2rem !important;">
    <thead>
      <tr style="text-align: center;">
        ...
        <th class="sorting" data-sorting_type="asc" data-column_name="wo_asset" style="cursor: pointer" width="30%">Desc Asset<span id="username_icon"></span></th>
        ...
        <th class="sorting" data-sorting_type="asc" data-column_name="wo_priority" style="cursor: pointer" width="5%">WO Type</th>
        <th class="sorting" data-sorting_type="asc" data-column_name="wo_priority" style="cursor: pointer" width="5%">Asset Group</th>
        <th class="sorting" data-sorting_type="asc" data-column_name="wo_priority" style="cursor: pointer" width="10%">Requested Date</th>
...
$(document).on('click', '.viewwo', function() {
  ...
  function fetch_data(page, sort_type, sort_by, wonumber, woasset, wostatus,woengineer,wocreator,woper1,woper2,wotype) {
    $.ajax({
      url: "/wobrowse/pagination?page=" + page + "&sorttype=" + sort_type + "&sortby=" + sort_by + "&wonumber=" + wonumber + "&woasset=" + woasset
      + "&wostatus=" + wostatus + "&woengineer=" + woengineer + "&wocreator=" + wocreator + "&woper1=" + woper1
