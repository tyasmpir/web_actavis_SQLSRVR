<!--------------- INI UNTUK PRINT TEMPLATE --------------->
  <table style="width:730px; height:10px; margin-top:-1.6cm;margin-left:-0.5cm;"class="borderless">    
    <td style="width: 710px; height:10px; text-align:left;vertical-align:middle;border:1px solid"> 
      ...
      <p style="margin-left: 0.5cm"><span style="display:inline-block;text-align: left;width:410px"><b>PT Actavis Indonesia</b></span><span style="display:inline-block;text-align: right;width:300px"><b>Ref. Lampiran 1 SOP 02-04-000-01</b></span> </p>      
    </td>
  ...
  <tr>
    ...
    @if($wotype != 'WO' && $wotype != 'WD')
    <p style="margin:1cm"><b>SPESIFIKASI KERJA PREVENTIVE MAINTENANCE</b></p>
    @else
    <p style="margin:1cm"><b>SPESIFIKASI KERJA WORK ORDER</b></p>
    @endif
