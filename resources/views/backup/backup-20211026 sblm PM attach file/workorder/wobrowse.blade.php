  ...
  <table class="table table-bordered mt-0" id="dataTable" width="100%" cellspacing="0" style="width:100%;padding: .2rem !important;">
    <thead>
      <tr style="text-align: center;">
        <th class="sorting" data-sorting_type="asc" data-column_name="wo_nbr" width="9%">Work Order Number<span id="name_icon"></span></th>
        ...
        <th class="sorting" data-sorting_type="asc" data-column_name="wo_status" width="5%">Status<span id="username_icon"></span></th>
        <!-- <th class="sorting" data-sorting_type="asc" data-column_name="wo_priority" width="5%">Priority</th> -->
        <th class="sorting" data-sorting_type="asc" data-column_name="wo_priority" width="5%">Type</th>
        ...
        <th class="sorting" data-sorting_type="asc" data-column_name="wo_creator" width="5%">Requested by</th>
      ...
      <form class="form-horizontal" id="newedit" method="post" action="editwo">
        ...
        <div class="modal-body">
          ...
          <div class="form-group row justify-content-center e_wottypediv" id="e_wottypediv">
            ...
            <div class="col-md-7">
              <select id="e_wottype"  class="form-control e_wottype" name="e_wottype"  autofocus required >
                <!-- <option value="" selected>Select Work Order Type</option> -->
                @foreach($wottype as $e_wottypeval)
                <option value="{{$e_wottypeval->wotyp_code}}">{{$e_wottypeval->wotyp_desc}}</option>
                @endforeach
              </select>
            </div>
          </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <div class="form-group row justify-content-center">
          ...
          <hr>
          <h6 style="text-align: center;"><b>Incomplete</b></h6>
...
<!--           
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-danger bt-action" id="ac_btnuncom">Incomplete</button>
  ...
  $(document).on('click', '.editwo2', function() {
    ...
    $.ajax({
      ...
      success:function(vamp){
        ...
        document.getElementById('e_wottype').selectedIndex   = ewottype;
  ...
  $(document).on('click', '.viewwo', function() {
    ...
    $.ajax({
      ...
      success:function(vamp){
        ...
        var vwottype    = result[0].wo_new_type;
        ...
        document.getElementById('v_loc').value            = loccode + ' -- ' + locdesc;
        document.getElementById('v_proc').value           = astypecode + ' -- ' + astypedesc;
        document.getElementById('counterfail').value      = counterfail;
        document.getElementById('apprwonbr2').value       = wonbr;
        document.getElementById('apprwonbr').value        = wonbr;
        ...
        $.ajax({
          ...
          data : {
            ...
            for(var i = 0; i < totalgambar; i++){
              ...
              test += '<button type="button" data-id="'+data[i].file_url+'" name="delfile" class="btn btn-danger delfile">';
              test += 'X</button>';
              test += '<a target="_blank" href="{{url('downloadwofinish/data[i].file_url')}}">'+data[i].file_name+'</a><br>';
              //test += '<td>'+pisah+'</td>';
