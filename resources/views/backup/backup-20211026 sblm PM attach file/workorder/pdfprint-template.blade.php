...
-->
 ...
 <tr>
    ...
    @else
      <td style="font-family:sans-serif;text-align:left;height:20px"><p style="margin: 0px">
        <b>Tgl : </b> 
        <!-- B211014 -->
        @if(!$datasr)
        @else
          @if(!is_null($datasr->sr_accept_date)) {{date('d-m-Y',strtotime($datasr->sr_accept_date))}} @endif 
        @endif
        </p>
      </td>
    @endif
