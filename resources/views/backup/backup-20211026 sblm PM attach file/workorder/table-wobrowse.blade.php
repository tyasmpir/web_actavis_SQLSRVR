...
<tr>
  ...
  <td>
    ...
    || ($show->wo_status == 'incomplete') {{-- A211019 --}} )
      &nbsp;
    ...
    &nbsp;
      <a id="aprint2" target="_blank" href="{{url('openprint2/'.$show->wo_nbr)}}" data-toggle="tooltip"  title="Print WO" ><i class="icon-table fas fa-print fa-lg"></i></a>  
    @endif
    &nbsp;
