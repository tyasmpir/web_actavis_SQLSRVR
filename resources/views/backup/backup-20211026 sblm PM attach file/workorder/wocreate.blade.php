...
@section('content-header')
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-9">
            <h1 class="m-0 text-dark">Work Order Engineer</h1>
          </div><!-- /.col -->
          <div class="col-sm-3">
  ...
  <table class="table table-bordered mt-0" id="dataTable" width="100%" cellspacing="0" style="width:100%;padding: .2rem !important;">
    <thead>
      <tr style="text-align: center;">
        ...
        <th class="sorting" data-sorting_type="asc" data-column_name="wo_created_at" style="cursor: pointer" width="12%">Created At</th>
...
$("#newedit").submit(function(e) {
  ...
  function fetch_data(page, sort_type, sort_by, wonumber, woasset, wostatus,wopriority,woperiod) {
    $.ajax({
      url: "/wocreate/pagination?page=" + page + "&sorttype=" + sort_type + "&sortby=" + sort_by + "&wonumber=" + wonumber + "&woasset=" + woasset+ "&wostatus=" + wostatus + "&wopriority="+wopriority+"&woperiod="+woperiod,
