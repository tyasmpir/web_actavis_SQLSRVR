...
<input type="hidden" id="tmpreqby" value="">
...
//alert(rprstatus);        
  ...
  function fetch_data(page, sort_type, sort_by, wonumber,woasset,wostatus,woengineer,woper1,woper2,wotype,woreqby) {
    $.ajax({
  ...
  $(document).on('click', '#btnsearch', function() {
    ...
    fetch_data(page, sort_type, column_name, wonumber, woasset,wostatus,woengineer,woper1,woper2,wotype,woreqby);
  });
  ...
  $(document).on('click', '.pagination a', function(event) {
    ...
    fetch_data(page, sort_type,column_name,wonumber,asset,status,engineer,woper1,woper2,wotype,woreqby);
  });
