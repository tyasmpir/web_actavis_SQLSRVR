...
@section('content-header')
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-9">
            <h1 class="m-0 text-dark">Work Order Create</h1>
          </div><!-- /.col -->
          <div class="col-sm-3">
...
<div class="table-responsive col-12 mt-0 pt-0 align-top">
  <table class="table table-bordered mt-0" id="dataTable" width="100%" cellspacing="0" style="width:100%;padding: .2rem !important;">
    ...
    <tbody>
      @include('workorder.table-wocreate')
    </tbody>
  </table>
  ...
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" id="new" method="post" action="createenwo" autocomplete="off">
          {{ csrf_field() }}
...
<div class="modal fade" id="editModal" role="dialog" aria-hidden="true" data-backdrop="static">
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      ...
      <form class="form-horizontal" id="newedit" method="post" action="editwoeng">
        {{ csrf_field() }}
        ...
        <div class="modal-body">
          ...
          <div class="form-group row justify-content-center" id="divfail1" style="display:none">
            ...
            <div class="col-md-7">
              <select id="e_failure1" class="form-control e_failure1"  >
              @foreach ($failure as $failure1)
                <option value="{{$failure1->fn_code}}">{{$failure1->fn_desc}}</option>
              @endforeach
              </select>
          ...
          <div class="form-group row justify-content-center" id="divfail2" style="display:none">
            ...
            <div class="col-md-7">
              ...
              @foreach ($failure as $failure2)
                <option value="{{$failure2->fn_code}}">{{$failure2->fn_desc}}</option>
              @endforeach
              </select>
          ...
          <div class="form-group row justify-content-center" id="divfail3" style="display:none">
            ...
            <div class="col-md-7">
              ...
              @foreach ($failure as $failure3)
                <option value="{{$failure3->fn_code}}">{{$failure3->fn_desc}}</option>
              @endforeach
              </select>
  ...
  $(document).on('click', '.editwo', function() {
    ...
    $.ajax({
      ...
      success:function(vamp){
        ...
        document.getElementById('e_failure1').value    = fc1 +' -- '+fn1;
        document.getElementById('e_failure2').value    = fc2 +' -- '+fn2;
        document.getElementById('e_failure3').value    = fc3 +' -- '+fn3;
        document.getElementById('counterfail').value   = counterfail;
