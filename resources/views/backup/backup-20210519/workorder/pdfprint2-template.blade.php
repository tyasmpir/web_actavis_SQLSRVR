...
<table style="width:730px; height:690px; margin-left:-1cm;margin-bottom:0px;"class="borderless">
  <tr>
    ...
    <td style="width: 80px;text-align:center" rowspan="16" >
  ...
  @foreach ($repair as $repair1)
    ...
    @if($currenttype !== $repair1->insg_desc)
      ...
      <table style="width:730px; height:140px;margin-top:-1.9cm; margin-left:-1cm;margin-bottom:0cm;page-break-after:always"class="borderless">
...
@include('workorder.pdfprint2-header')
  ...
  <tr>
    ...
    <tr>
      <td colspan="3" style="margin-top:0;height: 40px;"><p><b>{{$counterheader}}. SPARE PART CONSUMPTION</b></p>
      </td>
      <td style="margin-top:0; height: 40px;">
      </td>
      <td style="text-align:center;margin-top:0;height: 40px;">
  ...
  <table style="width:730px; height:140px;margin-top:-1.9cm; margin-left:-1cm;margin-bottom:0cm;"class="borderless">
  @include('workorder.pdfprint2-footer')
