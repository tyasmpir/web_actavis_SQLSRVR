...
<script type="text/javascript">
  ...
  function fetch_data(page, sort_type, sort_by, wonumber,woasset,wostatus,wocreatedate,tipewo) {
    ...
    $.ajax({
      url: "/datagrafytdwo/"+urlnow +"/pagination?page=" + page + "&sorttype=" + sort_type + "&sortby=" + sort_by + "&wonumber=" + wonumber + "&woasset=" + woasset + "&wostatus=" + wostatus + "&wocreatedate="+wocreatedate+"&tipewo="+tipewo,
