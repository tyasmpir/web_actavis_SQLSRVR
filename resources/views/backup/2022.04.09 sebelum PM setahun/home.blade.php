...
<script>
    ...
    <?php
      echo 'toplabel5.push("WO in Month");topdata5.push("'.$countwomonth->countwomonth.'");topdatapm5.push("'.$countwopmmonth->countwopmmonth.'");';
      echo 'toplabel5.push("WO Open");topdata5.push("'.$countwoopen->countwoopen.'");topdatapm5.push("'.$countwopmopen->countwopmopen.'");';
      echo 'toplabel5.push("WO in Progress");topdata5.push("'.$countwostart->countwostart.'");topdatapm5.push("'.$countwopmstart->countwopmstart.'");';
      echo 'toplabel5.push("WO Finish");topdata5.push("'.$countwofinish->countwofinish.'");topdatapm5.push("'.$countwopmfinish->countwopmfinish.'");';
    //  
    ?>
