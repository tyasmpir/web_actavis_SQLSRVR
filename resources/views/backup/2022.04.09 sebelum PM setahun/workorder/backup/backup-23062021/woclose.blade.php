    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        // console.log('aaaa');
          ...
          col+='<tr>';
          // alert(result[i].reppart_desc);
          if(result[i].reppart_desc == null){
            col+='<td style="margin-top:0;height:40px;border:2px solid"><p style="margin:0px;"><b>-</b></p></td>';
          }
          else{
            col+='<td style="margin-top:0;height:40px;border:2px solid"><p style="margin:0px;"><b>'+result[i].reppart_desc+'</b></p></td>';  
          }
