                ...
                <form class="form-horizontal" method="post" action="/createreppart">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="col-md-6">
                                <select id="t_code" class="form-control" name="t_code" required>
                                    ...
                                    @foreach($datarep as $data)
                                      <option value="{{$data->rep_code}}">{{$data->rep_code}} -- {{$data->rep_num}} -- {{$data->rep_desc}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="t_step" type="number" class="form-control" name="t_step"
                                autocomplete="off" autofocus max="99" required />
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="t_spm" class="col-md-4 col-form-label text-md-right">Spare Part Code</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="t_qty" type="number" class="form-control" name="t_qty"
                                autocomplete="off" autofocus max="999" required />
                            </div>
                        </div>
                    </div>
            ...
            <form class="form-horizontal" method="post" action="/editreppart">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="te_step" type="text" class="form-control" name="te_step" readonly/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="te_spm" class="col-md-4 col-form-label text-md-right">Spare Part</label>
                        <div class="col-md-6">
                            <select id="te_spm" class="form-control" name="te_spm" readonly>
                                <option value="">--Select Data--</option>
                                @foreach($datasp as $data)
                                  <option value="{{$data->spm_code}}">{{$data->spm_code}} -- {{$data->spm_desc}}</option>
                                @endforeach
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="te_qty" type="number" class="form-control" name="te_qty"
                            autocomplete="off" autofocus max="999" required />
                        </div>
                    </div>
                </div>
