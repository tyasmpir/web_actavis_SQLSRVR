...
<div class="col-12 form-group row">
    ...
    <label for="s_desc" class="col-md-2 col-sm-2 col-form-label text-md-right">Desc</label>
    <div class="col-md-4 mb-2 input-group">
...
<div class="table-responsive col-12">
    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
            <!-- untuk isi table -->
            @include('setting.table-repair-code')
        </tbody>
    </table>
...
<div class="modal fade" id="createModal" role="dialog" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" action="/createrepcode">
                {{ csrf_field() }}
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                           <input id="t_code" type="text" class="form-control" name="t_code" autocomplete="off" required maxlength="10">       
                        </div>
                    </div>
					<div class="form-group row">
                        ...
                        <span id="alert1" style="color: red; font-weight: 200;">*</span></label>
                        <div class="col-md-6">
                           <input id="t_desc" type="text" class="form-control" name="t_desc" autocomplete="off" required maxlength="50">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="t_ref" class="col-md-4 col-form-label text-md-right">Reference</label>
                        <div class="col-md-6">
                           <input id="t_ref" type="text" class="form-control" name="t_ref" autocomplete="off" maxlength="50">              
                        </div>
                    </div>
...
<div class="modal fade" id="editModal" role="dialog" aria-hidden="true" data-backdrop="static">
    ...
    <div class="modal-content">
        ...
        <form class="form-horizontal" method="post" action="/editrepcode">
            {{ csrf_field() }}
            <div class="modal-body">
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <span id="alert1" style="color: red; font-weight: 200;">*</span></label>
                    <div class="col-md-6">
                        <input id="te_desc" type="text" class="form-control" name="te_desc" required maxlength="50"/>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="te_ref" class="col-md-4 col-form-label text-md-right">Reference</label>
                    <div class="col-md-6">
                        <input id="te_ref" type="text" class="form-control" name="te_ref" maxlength="50"/>
                    </div>
                </div>
...
<div class="modal fade" id="deleteModal" role="dialog" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" action="/deleterepcode">
                {{ csrf_field() }}
                <div class="modal-body">
                    <input type="hidden" id="d_code" name="d_code">
                    <input type="hidden" id="d_desc" name="d_desc">
                    Delete Repair Code <b><span id="td_code"></span> -- <span id="td_desc"></span></b> ?
                </div>
    ...
    <script>
       $(document).on('click', '#editdata', function(e){
           ...
           document.getElementById('te_ref').value = ref;
            ...
            $.ajax({
                url:"editdetailrepcode?code="+code,
       ...
       function fetch_data(page, sort_type, sort_by, code, desc){
            $.ajax({
                url:"/repcode/pagination?page="+page+"&sorttype="+sort_type+"&sortby="+sort_by+"&code="+code+"&desc="+desc,
                success:function(data){
                    console.log(data);
       ...
       $(document).on('click', '#btnrefresh', function() {
        ...
        $("#addrow").on("click", function() {
          ...
          @else
              ...
              @endforeach
              cols += '</select>';
              cols += '<input type="hidden" name="insdesc" value="{{$da->ins_desc}}">';
              cols += '</td>';
          @endif
        ...
        $("#ed_addrow").on("click", function() {
          ...
          @else
              ...
              cols += '<input type="hidden" name="einsdesc[]" id="einsdesc" class="einsdesc" value="{{$da->ins_desc}}">';
              cols += '</td>';
          @endif
          cols += '<td data-title="Action"><input type="button" class="ibtnDel btn btn-danger btn-focus"  value="Delete"></td>';
          cols += '</tr>'
