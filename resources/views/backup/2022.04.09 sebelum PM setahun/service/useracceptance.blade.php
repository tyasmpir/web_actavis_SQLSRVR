                ...
                <form class="form-horizontal" id="acceptance" method="post" action="/acceptance" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-md-4">
                            <input id="startwo" readonly type="date" class="form-control" name="startwo">
                          </div>
                          <label for="endwo" class="col-md-2 col-form-label">End Date</label>
                          <div class="col-md-4">
                            <input id="endwo" type="date" class="form-control" name="endwo" readonly>
                          </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <!-- End A211014 -->
                        ...
                        <div class="form-group row">
                          <label for="uncompletenote" class="col-md-3 col-form-label text-md-left">Reason Incomplete</label>
                          <div class="col-md-7">
                              <textarea id="uncompletenote" type="text" class="form-control" name="uncompletenote" rows="3" maxlength="250" autocomplete="off" autofocus></textarea>
                          </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-footer">
                      ...
                      <button type="submit" class="btn btn-danger" name="action" value="incomplete" id="btnreject">Incomplete</button>
                      <button type="submit" class="btn btn-success" name="action" value="complete" id="btnapprove">Complete</button> 
