  ...
  <table class="table table-bordered mt-4 no-footer mini-table" id="dataTable" width="100%" cellspacing="0">
    <thead>
      <tr style="text-align: center;">
        <th class="sorting" data-sorting_type="asc" width="15%">SR Number<span id="name_icon"></span></th>
        <th class="sorting" data-sorting_type="asc" width="15%">Asset<span id="username_icon"></span></th>
        <th class="sorting" data-sorting_type="asc" width="35%">Desc Asset<span id="username_icon"></span></th>
        <th class="sorting" data-sorting_type="asc" width="15%">Requested by<span id="username_icon"></span></th>
...
$(document).ready(function(){
    ...
    $(document).on('click', '.approval', function() {
      ...
      if (reptype == "code") {
        document.getElementById('rad_repgroup1').checked = false;
        document.getElementById('rad_repgroup2').checked = true;
        document.getElementById('tampilanrepcode').style.display='';
        document.getElementById('tampilanrepgroup').style.display='none';
        document.getElementById('repgroup').value=null;
        $("#repgroup").val(null).trigger('change');
        $("#repaircode").val(rep).trigger('change');
