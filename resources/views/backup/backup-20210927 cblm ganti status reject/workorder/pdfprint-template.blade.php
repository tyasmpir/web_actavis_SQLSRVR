...
<tr>
 ...
 <td style="width: 350px;" colspan="2">
  ...
  <td  colspan="2">{{$data[0]->wo_action}}</td>
  </tr>
  <tr></tr>
  <tr>
  <td style="width: 250px;">
   ...
   <td  colspan="2">{{$data[0]->wo_sparepart}}</td>
</tr>
...
-->
 ...
 <tr>
    ...
    @if($data[0]->wo_reviewer != null)
      <td style="font-family:sans-serif;text-align:center;height:50px;vertical-align:middle"><b>{{$data[0]->wo_reviewer}}</b></td>  
    
    @else
      <td style="font-family:sans-serif;text-align:center;height:50px;vertical-align:middle"></td>  
    @endif
    @if($data[0]->wo_approver != null)
      <td style="font-family:sans-serif;text-align:center;height:50px;vertical-align:middle"><b>{{$data[0]->wo_approver}}</b></td>  
    ...
    <tr>
    <td style="font-family:sans-serif;text-align:left;height:20px"><p style="margin: 0px"><b>Tgl  </b> {{date('d-m-Y',strtotime($data[0]->wo_created_at))}}</p></td>
