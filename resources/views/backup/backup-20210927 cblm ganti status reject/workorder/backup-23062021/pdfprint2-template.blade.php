      ...
      @if($currenttype !== $repair1->insg_desc)
        @if(($counter + $counter2) != $batasakhir)
            ...
            @else
                @php($counter2 +=1)
                <tr>  
                  <td colspan="2" style="height:55px"><p style="margin:0px"><b>{{$counterheader}}.{{$repair1->insg_desc}}</b></p></td>
                  <td style="height:55px" ></td>
                  <td style="height:55px"></td>
                  <td style="height:55px"></td>
        ...
        @if(($counter + $counter2) != $batasakhir)
          <tr>
            <td colspan="2" style="margin-top:0;height:55px">
            @if($repair1->reppart_desc == null)
              <p style="margin:0px;font-size: 12px"><b></b></p>
            @else
              <p style="margin:0px;font-size: 12px"><b>{{$repair1->reppart_desc}}</b></p>
            @endif
            </td>
            <td style="margin-top:0;height:55px">
          ...
          <tr>
            ...
            @if ($currenttype !== $repair1->insg_desc)
                ...
                @else
                    @php($counter2 +=1)
                    <tr>  
                        <td colspan="2" style="height:55px"><p style="margin:0px"><b>{{$counterheader}}.{{$repair1->spt_desc}}</b></p></td>
                        <td style="height:55px"></td>
                        <td style="height:55px"></td>
                        <td style="height:55px"></td>
