      ...
      <form class="form-horizontal" id="newedit" method="post" action="editwo">
        ...
        <div class="modal-body">
          <div class="form-group row justify-content-center">
            <label for="e_nowo" class="col-md-5 col-form-label text-md-left">Work Order Numberxx</label>
            <div class="col-md-7">
      ...
      <div class="modal-header">
        ...
        <div class="form-group row justify-content-center">
          ...
          <div class="form-group row justify-content-center" id="reportnote" >
            <label for="v_reportnote" class="col-md-5 col-form-label text-md-left">Reporting Note</label>
            <div class="col-md-7">
            <textarea id="ac_reportnote" class="form-control ac_reportnote" name="ac_reportnote" autofocus readonly></textarea>
            </div>
          </div>
