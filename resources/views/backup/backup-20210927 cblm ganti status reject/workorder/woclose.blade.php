      ...
      <form class="form-horizontal" id="neweditother" method="post" action="/reportingwoother">
        ...
        <div class="modal-body">
          <div class="form-group row justify-content-center">
            ...
            <div class="col-md-8">
              <input id="o_wonbr" type="text" class="form-control" name="o_wonbr"  autocomplete="off" readonly autofocus>
            </div>
          </div>
          <div class="form-group row justify-content-center">
            <label for="o_srnbr" class="col-md-4 col-form-label text-md-left">SR Number</label>
            <div class="col-md-8">
              <input id="o_srnbr" type="text" class="form-control" name="o_srnbr"  readonly autofocus>
            </div>
          </div>
          <div class="form-group row justify-content-center">
            <label for="o_asset" class="col-md-4 col-form-label text-md-left">Asset</label>
            <div class="col-md-8">
              <input type="text" readonly id="o_asset" type="text" class="form-control o_asset" name="o_asset" autofocus >
