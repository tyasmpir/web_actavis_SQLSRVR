...
<div class="col-12 form-group row">
  ...
  <div class="col-md-4 col-sm-12 mb-2 input-group">
    <input id="s_nomorwo" type="text" class="form-control"  name="s_nomorwo" value="{{$tmpwo}}" autofocus autocomplete="off">
  </div>
  ...
  <label for="" class="col-md-12 col-form-label text-md-right">{{ __('') }}</label>
...
<input type="hidden" id="tmpengineer" value="{{$engine}}"/>
  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <form class="form-horizontal" id="newedit" method="post" action="/reportingwo" enctype="multipart/form-data">
        ...
        <input type="hidden" name="wtmpstatus" id="wtmpstatus" value="{{$tmpstatus}}" >
        <input type="hidden" name="wtmpwo" id="wtmpwo" value="{{$tmpwo}}">
        <input type="hidden" name="wtempasset" id="wtmpasset" value="{{$tmpasset}}">
        <input type="hidden" name="wtmpengineer" id="wtmpengineer" value="{{$engine}}">
        <input type="hidden" name="wpage" id="wpage" value="{{$page}}">
        ...
        <div class="form-group row col-md-12">
          ...
          <div class="col-md-3 h-50">
            <label for="c_srnbr" class="col-md-12 col-form-label text-md-left p-0"></label>
          </div>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form class="form-horizontal" id="neweditother" method="post" action="/reportingwoother" enctype="multipart/form-data">
        ...
        <input type="hidden" name="otmpstatus" id="otmpstatus" value="{{$tmpstatus}}" >
        <input type="hidden" name="otmpwo" id="otmpwo" value="{{$tmpwo}}">
        <input type="hidden" name="otempasset" id="otmpasset" value="{{$tmpasset}}">
        <input type="hidden" name="otmpengineer" id="otmpengineer" value="{{$engine}}">
        <input type="hidden" name="opage" id="opage" value="{{$page}}">
        ...
        <div class="modal-body">
          ...
          <div class="form-group row justify-content-center">
            ...
            <div class="col-md-8">
            <input id="o_finishdate" type="date" class="form-control o_finishdate" name="o_finishdate" autofocus required>
            </div>
          </div>
          <div class="form-group row justify-content-center">
            <label for="o_finishtime" class="col-md-4 col-form-label text-md-left">Finish Time <span id="alert1" style="color: red; font-weight: 200;">*</span></label>
            <div class="col-md-8">
            <select id="o_finishtime" class="form-select o_finishtime" name="o_finishtime" style="border:2px solid #ced4da;border-radius:.25rem" autofocus required>
              <option value='00'>00</option>
              <option value='01'>01</option>
              <option value='02'>02</option>
              <option value='03'>03</option>
            ...
            :
            <select id="o_finishtimeminute" class="form-select c_finishtime" name="o_finishtimeminute" style="border:2px solid #ced4da;border-radius:.25rem" autofocus required>
              <option value='00'>00</option>
              <option value='01'>01</option>
              <option value='02'>02</option>
              <option value='03'>03</option>
...
$(document).on('click', '#btnsearch', function() {
    ...
    document.getElementById('wtmpwo').value        = wonumber;
    document.getElementById('wtmpasset').value     = woasset;
    document.getElementById('wtmpstatus').value    = wostatus;

    document.getElementById('otmpwo').value        = wonumber;
    document.getElementById('otmpasset').value     = woasset;
    document.getElementById('otmpstatus').value    = wostatus;
