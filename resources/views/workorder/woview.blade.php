...
<div class="col-12 form-group row">
  ...
  <div class="col-md-3 col-sm-12 mb-2 input-group">
    <select id="s_impact"  class="form-control s_impact" name="s_impact[]" >
      ...
      <option value="{{$s_impact->wotyp_code}}">{{$s_impact->wotyp_code}} -- {{$s_impact->wotyp_desc}}</option>
      @endforeach
    </select>
  </div>
  <label for="" class="col-md-2 col-form-label text-center">{{ __(' ') }}</label>
...
<input type="hidden" id="tmpimpact" value=""/>
...
$(document).on('click', '.viewwo', function() {
  ...
  function fetch_data(page, sort_type, sort_by, wonumber, woasset, wostatus,woengineer,wocreator,woper1,woper2,wotype,woimpact) {
    $.ajax({
      url: "/wobrowse/pagination?page=" + page + "&sorttype=" + sort_type + "&sortby=" + sort_by + "&wonumber=" + wonumber 
      + "&woasset=" + woasset + "&wostatus=" + wostatus + "&woengineer=" + woengineer + "&wocreator=" + wocreator 
      + "&woper1=" + woper1 + "&woper2=" + woper2 + "&wotype=" + wotype + "&woimpact=" + woimpact ,
  ...
  $(document).on('click', '#btnsearch', function() {
    ...
    fetch_data(page, sort_type, column_name, wonumber, woasset,wostatus,woengineer,wocreator,woper1,woper2,wotype,woimpact);
  });
  ...
  $(document).on('click', '.sorting', function() {
    ...
    fetch_data(page, reverse_order, column_name, wonumber, assert,status,engineer,creator,woper1,woper2,wotype,woimpact);
  });
  ...
  $(document).on('click', '.pagination a', function(event) {
    ...
    fetch_data(page, sort_type, column_name, wonumber, asset,status,engineer,creator,woper1,woper2,wotype,woimpact);
  });
  ...
  $(document).on('click', '#btnexcel', function() {
    ...
    window.open("/donlodwo?wonumber=" + wonumber +"&asset="+woasset+"&status="+wostatus+"&priority="+wopriority+"&engineer="+woengineer+"&creator"+wocreator+ "&woper1=" + woper1 + "&woper2=" + woper2 + 
      "&wotype=" + wotype + "&woimpact=" + woimpact,'_blank');
  });
