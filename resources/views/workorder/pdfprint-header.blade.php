<!-- Daftar Perubahan 
  A221027 : Perubahan report berdasarkan email RE: Tampilan Report WO di EAM
-->
...
<table style="width:700px; height:30px; margin-top:0.5cm; margin-bottom:-0.4cm" class="borderless">
  ...
  <tr>
    ...
    <td style="width: 200px; height:30px; text-align:center;vertical-align:top;border:1px solid" > 
      <p>Legacy Number : 02-03-000-09-1</p>
    </td>
    <td style="width: 150px; height:30px; text-align:center;vertical-align:top;border:1px solid;" >
      <p>Revision Number : 2.0</p>
    </td>  
    {{--  <td style="width: 300.724px; height:60px;  text-align:center;vertical-align:top;border:1px solid">  --}}
    <td style="width: 200px; height:60px;  text-align:center;vertical-align:top;border:1px solid">
      <p>Ref. to SOP : 02-03-000-09</p>
    </td>
  </tr>  
