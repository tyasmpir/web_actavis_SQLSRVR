        ...
        <li class="nav-item">
          <div class="col-12 form-group row">
            ...
            <label for="s_creator" class="col-md-2 col-form-label text-md-right">{{ __('Requested by') }}</label>
              ...
              <div class="col-md-3 col-sm-12 mb-2 input-group">
                <input id="s_per2" type="date" class="form-control" name="s_per2" value="{{$tmpper2}}">
              </div>
...
<div class="col-12 form-group row">
    ...
    <div class="modal-dialog modal-md " role="document">
      <div class="modal-content">
        ...
        <form class="form-horizontal" id="newedit" method="post" action="editjob">
          ...
          <input type="hidden" name="tmpwo" id="tmpwo" value="{{$tmpwo}}"/>
          <input type="hidden" name="tmpasset" id="tmpasset" value="{{$tmpasset}}"/>
          <input type="hidden" name="tmpstatus" id="tmpstatus" value="{{$tmpstatus}}"/>
          <!-- <input type="hidden" name="tmppriority" id="tmppriority" value=""/>
          <input type="hidden" name="tmpperiod" id="tmpperiod" value=""/> -->
          <input type="hidden" name="tmpengineer" id="tmpengineer" value="{{$englogin}}"/>
          <input type="hidden" name="tmpcreator" id="tmpcreator" value="{{$tmpcreator}}"/>
          <input type="hidden" name="tmpper1" id="tmpper1" value="{{$tmpper1}}"/>
          <input type="hidden" name="tmpper2" id="tmpper2" value="{{$tmpper2}}"/>
          <input type="hidden" name="tmpwotype"" id="tmpwotype" value="{{$tmpwotype}}"/>
          ...
          <div class="modal-body">
            ...
            <div class="form-group row justify-content-center">
              ...
              <div class="col-md-7">
                <input type="text" readonly id="v_note" type="text" class="form-control v_note" name="v_note" autofocus >
              </div>
            </div>
            ...
            <div class="form-group row justify-content-center">
              <label for="v_start" class="col-md-5 col-form-label text-md-left">Start Date</label>
              <div class="col-md-7">
                <input id="v_start" type="date" class="form-control" name="v_start" autofocus>
              </div>
            </div>
            <div class="form-group row justify-content-center">
  ...
  <script>
    ...
    function fetch_data(page, sort_type, sort_by, wonumber,woasset, wostatus,woengineer,wocreator,woper1,woper2,wotype) {
      $.ajax({
        url: "/wojoblist/pagination?page=" + page + "&sorttype=" + sort_type + "&sortby=" + sort_by + "&wonumber=" + 
        wonumber + "&woasset=" + woasset + "&wostatus=" + wostatus + "&woengineer=" + woengineer + "&wocreator=" + wocreator + "&woper1=" + woper1
      + "&woper2=" + woper2 + "&wotype=" + wotype ,
    ...
    $.ajax({
      ...
      success:function(vamp){
        ...
        if(wostatus == 'open'){
          ...
          document.getElementById('v_start').value = dstart;
        }
        ...
        document.getElementById('v_asset').value      = asscode;
        document.getElementById('v_assetdesc').value  = asset;
        ...
        document.getElementById('tmpwo').value        = $('#s_nomorwo').val(); 
        document.getElementById('tmpasset').value     = $('#s_asset').val(); 
        //document.getElementById('tmppriority').value  = wopriority;
        document.getElementById('tmpengineer').value  = $('#s_engineer').val(); 
        document.getElementById('tmpcreator').value   = $('#s_creator').val();
        document.getElementById('tmpper1').value      = $('#s_per1').val();
        document.getElementById('tmpper2').value      =  $('#s_per2').val();
        document.getElementById('tmpwotype').value    = $('#s_typewo').val();
...
$(document).on('click', '.pagination a', function(event) {
  ...
  fetch_data(page, sort_type, column_name, wonumber, asset,status,woengineer,wocreator,woper1,woper2,wotype);
});
