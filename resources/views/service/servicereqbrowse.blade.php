...
$(document).ready(function(){
    ...
    $(document).on('click', '.view', function() {
      ...
      if (startwo != '01-01-1970') { document.getElementById('startwo').value = startwo; } 
      else { document.getElementById('startwo').value = ''; }
      if (endwo != '01-01-1970') { document.getElementById('endwo').value = endwo;} 
