...
@section('content-header')
      <div class="container-fluid">
        ...
        <div class="row">                 
          <div class="col-sm-2">    
            <button class="btn btn-block btn-primary" data-toggle="modal" data-target="#createModal">Skills Create</button>
          </div><!-- /.col -->  
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
@endsection
...
<div class="col-12 form-group row">
    <div class="col-12 form-group row">
        <label for="s_code" class="col-md-2 col-sm-2 col-form-label text-md-right">Skills Code</label>
        <div class="col-md-4 mb-2 input-group">
            <input id="s_code" type="text" class="form-control" name="s_code"
            value="" autofocus autocomplete="off"/>
        </div>
        <label for="s_desc" class="col-md-2 col-sm-2 col-form-label text-md-right">Skills Description</label>
        <div class="col-md-4 mb-2 input-group">
...
<div class="table-responsive col-12">
    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
            <!-- untuk isi table -->
            @include('setting.table-skillb')
        </tbody>
    </table>
    <input type="hidden" name="hidden_page" id="hidden_page" value="1"/>
    <input type="hidden" name="hidden_column_name" id="hidden_column_name" value="skill_code"/>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center" id="exampleModalLabel">Skills Create</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form class="form-horizontal" method="post" action="/createskill">
                {{ csrf_field() }}
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="t_cer" class="col-md-4 col-form-label text-md-right">Certification</label>
                        <div class="col-md-6">
                            <input id="t_cer" type="text" class="form-control" name="t_cer" autocomplete="off" autofocus maxlength="30"/>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="editModal" role="dialog" aria-hidden="true" data-backdrop="static">
    ...
    <div class="modal-content">
        <div class="modal-header">
        <h5 class="modal-title text-center" id="exampleModalLabel">Skills Modify</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
        </div>
        <form class="form-horizontal" method="post" action="/editskill">
            {{ csrf_field() }}
            <div class="modal-body">
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <label for="te_cer" class="col-md-4 col-form-label text-md-right">Certification</label>
                    <div class="col-md-6">
                        <input id="te_cer" type="text" class="form-control" name="te_cer" autocomplete="off" autofocus maxlength="30"/>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="deleteModal" role="dialog" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
            <h5 class="modal-title text-center" id="exampleModalLabel">Skills Delete</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
            </div>
            <form class="form-horizontal" method="post" action="/deleteskill">
                {{ csrf_field() }}
                <div class="modal-body">
                    <input type="hidden" id="d_code" name="d_code">
                    Delete Skills <b><span id="td_code"></span> -- <span id="td_desc"></span></b> ?
                </div>
...
@section('scripts')
    <script>
       $(document).on('click', '#editdata', function(e){
           ...
           document.getElementById('te_cer').value  = cer;
       });
       ...
       function fetch_data(page, sort_type, sort_by, code, desc){
            $.ajax({
                url:"skillmaster/pagination?page="+page+"&sorttype="+sort_type+"&sortby="+sort_by+"&code="+code+"&desc="+desc,
        ...
        $(document).on('change','#t_code',function(){
            ...
            $.ajax({
              ...
              success: function(data) {
                ...
                if (data == "ada") {
                  alert("Skill Already Registered!!");
        ...
        $(document).on('change','#t_desc',function(){
            ...
            $.ajax({
              ...
              success: function(data) {
                ...
                if (data == "ada") {
                  alert("Description Skill Already Registered!!");
