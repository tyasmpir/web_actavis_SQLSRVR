...
<!-- 
    ...
    A221121 : Last maintenance dibuka field nya
 -->
        ...
        <form class="form-horizontal" method="post" action="/editasset" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="te_lastusage" type="text" class="form-control" name="te_lastusage"/>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="te_lastusagemtc" class="col-md-4 col-form-label text-md-right">Last Usage maintenance</label>
                    <div class="col-md-6">
                        <input id="te_lastusagemtc" type="text" class="form-control" name="te_lastusagemtc"/>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="te_lastmtc" class="col-md-4 col-form-label text-md-right">Last Maintenance</label>
                    <div class="col-md-6">
                        <input id="te_lastmtc" type="date" class="form-control" name="te_lastmtc" placeholder="yy-mm-dd" autocomplete="off"/>
                    </div>
                </div>
                <div class="form-group row">
...
@section('scripts')
    <script>
       ...
       $(document).on('click', '#editdata', function(e){
           ...
           if(onuse == '' || onuse == null) {
            document.getElementById('te_lastusage').readOnly = false;
            document.getElementById('te_lastusagemtc').readOnly = false;
            {{--  document.getElementById('te_lastmtc').readOnly = false;  --}}
           } else {
            document.getElementById('te_lastusage').readOnly = true;
            document.getElementById('te_lastusagemtc').readOnly = true;
            {{--  document.getElementById('te_lastmtc').readOnly = true;  --}}
           }
