    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center" id="exampleModalLabel">Create Repair Code</h5>
            ...
            <form class="form-horizontal" method="post" action="/createrepdet">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="t_code" class="col-md-4 col-form-label text-md-right">Repair Code Decription</label>
                        <div class="col-md-6">
                            <input id="t_step" type="text" class="form-control" name="t_step"
                            autocomplete="off" autofocus maxlength="2" required pattern="[0-9]{0,3}" title="Masukan hanya angka 0-9. Maks.2"/>
                        </div>
                    ...
                    <div class="col-md-10 offset-md-1">
                        <table width="100%" id='assetTable' class='table table-striped table-bordered dataTable no-footer order-list' style="table-layout: fixed;">
                          <thead>
                            <tr id='full'>
                              <th width="10%">Line</th>
                              <th width="30%">Part</th>
                              <th width="30%">Instruction</th>
                              <th width="20%">Standard Condition</th>
                              <th width="10%"></th>
                            </tr>
                          </thead>
                          <tbody id='detailapp'>
...
//alert('aaa');
       ...
       $(document).on('click', '#btnrefresh', function() {
        ...
        $("#addrow").on("click", function() {
          ...
          cols += '<td data-label="Line">';
          cols += '<input type="text" style="width:50px;">';
          cols += '</td>';

          cols += '<td data-label="Part">';
          cols += '<select id="t_part" class="form-control t_part selectpicker" name="t_part[]" data-live-search="true" required autofocus>';
          ...
          cols += '<td data-label="Instruction">';
          cols += '<select id="t_ins" class="form-control t_ins selectpicker" name="t_ins[]" data-live-search="true" required autofocus>';
          cols += '<option value = ""> -- Select Data -- </option>'
          @foreach($datains as $da)
          cols += '<option value="{{$da->ins_code}}"> {{$da->ins_code}} -- {{$da->ins_desc}} </option>';
          @endforeach
          ...
          cols += '<td data-label="Standard">';
          cols += '<input type="text" style="width:100px;">';
          cols += '</td>';
