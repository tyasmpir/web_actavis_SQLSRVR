...
<div class="table-responsive col-12">
    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        <thead>
            <tr>
                <th class="sorting" data-sorting_type="asc" data-column_name="repm_code" style="cursor: pointer;" style="width: 15%;">Repair Code<span id="location_id_icon"></span></th>
                <th style="width: 35%;">Repair Code Description</th>
                <th style="width: 15%;">Reference</th>
                <th style="width: 25%;">Instruction Group</th>  
                <th style="width: 10%;">Action</th>  
            </tr>
        </thead>
        <tbody>
            <!-- untuk isi table -->
            @include('setting.table-repairb')
        </tbody>
    </table>
    <input type="hidden" name="hidden_page" id="hidden_page" value="1"/>
    <input type="hidden" name="hidden_column_name" id="hidden_column_name" value="repm_code"/>
...
<div class="modal fade" id="createModal" role="dialog" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" action="/createrepb">
                {{ csrf_field() }}
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="t_code" class="col-md-4 col-form-label text-md-right">Repair Code
                    ...
                    <div class="form-group row">
                        <label for="t_desc" class="col-md-4 col-form-label text-md-right">Repair Code Description
                        <span id="alert1" style="color: red; font-weight: 200;">*</span></label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <label for="t_ins" class="col-md-4 col-form-label text-md-right">Instruction Group</label>
                        <div class="col-md-6">
                            <select id="t_ins" class="form-control t_ins" name="t_ins" >
                                <option value="">--Select Data--</option>
                                @foreach($datains as $de)
                                  <option value="{{$de->insg_code}}">{{$de->insg_code}} -- {{$de->insg_desc}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
...
<div class="modal fade" id="editModal" role="dialog" aria-hidden="true" data-backdrop="static">
    ...
    <div class="modal-content">
        ...
        <form class="form-horizontal" method="post" action="/editrepb">
            {{ csrf_field() }}
            <div class="modal-body">
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <label for="te_desc" class="col-md-4 col-form-label text-md-right">Repair Code Description
                    <span id="alert1" style="color: red; font-weight: 200;">*</span></label>
                    <div class="col-md-6">
                ...
                <div class="form-group row">
                    <label for="te_ins" class="col-md-4 col-form-label text-md-right">Instruction</label>
                    <div class="col-md-6">
                        <select id="te_ins" class="form-control te_ins" name="te_ins" >
                            <option value="">--Select Data--</option>
                            @foreach($datains as $de)
                              <option value="{{$de->insg_code}}">{{$de->insg_code}} -- {{$de->insg_desc}}</option>
                            @endforeach
...
<div class="modal fade" id="deleteModal" role="dialog" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" action="/deleterepb">
                {{ csrf_field() }}
                <div class="modal-body">
                    <input type="hidden" id="d_code" name="d_code">
                    <input type="hidden" id="d_desc" name="d_desc">
                    Are you sure want to delete Repair Code <b><span id="td_code"></span> -- <span id="td_desc"></span></b> ?
                </div>
...
@section('scripts')
    <script>
       ...
       function fetch_data(page, sort_type, sort_by, code, desc){
            $.ajax({
                url:"repmasterb/pagination?page="+page+"&sorttype="+sort_type+"&sortby="+sort_by+"&code="+code+"&desc="+desc,
