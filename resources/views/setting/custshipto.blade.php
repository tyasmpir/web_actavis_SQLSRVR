...
@section('content')
  ...
  <div class="table-responsive col-12" style="overflow: auto; display: block;white-space: nowrap; margin-left: auto; margin-right: auto;">
      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        <thead>
          <tr>
             <th class="sorting" data-sorting_type="asc" data-column_name= "cust_code" style="cursor: pointer" width="50%">Customer Code<span id="name_icon"></span></th>
             <th class="sorting" data-sorting_type="asc" data-column_name= "shipto" style="cursor: pointer">Ship To</th>  
          </tr>
       </thead>
        <tbody>
...
<script>
    ...
    function getdata(page, sort_type, sort_by) {
        $.ajax({
            url: "/custshipto?page=" + page + "&sorttype=" + sort_type + "&sortby=" + sort_by, 
            success: function(data) {
                console.log(data);
                $('tbody').html('');
                $('tbody').html(data);
