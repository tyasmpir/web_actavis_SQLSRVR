...
//dd($req->all());
    ...
    if ($deskripsi == "In Month") {
      $kondisi = "and month(wo_created_at) = ".$bulan." and year(wo_created_at) = ".$tahun;
    } elseif ($deskripsi == "Open") {
      $kondisi = "and month(wo_created_at) = ".$bulan." and year(wo_created_at) = ".$tahun." and wo_status='open'";
    } elseif ($deskripsi == "Started") {
      $kondisi = "and month(wo_start_date) = ".$bulan." and year(wo_start_date) = ".$tahun." and wo_status = 'started'";
    } elseif ($deskripsi == "Finish") {
      $kondisi = "and month(wo_finish_date) = ".$bulan." and year(wo_finish_date) = ".$tahun." and wo_status in ('finish')";
    } elseif ($deskripsi == "Completed") {
      $kondisi = "and month(wo_finish_date) = ".$bulan." and year(wo_finish_date) = ".$tahun." and wo_status in ('completed')";
    } elseif ($deskripsi == "Closed") {
      $kondisi = "and month(wo_finish_date) = ".$bulan." and year(wo_finish_date) = ".$tahun." and wo_status in ('closed')";
    }
