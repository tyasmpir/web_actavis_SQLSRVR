    ...
    public function wobrowse(){ /* route : womaint blade : workorder.wobrowse */
        if (strpos(Session::get('menu_access'), 'WO01') !== false) {
            ...
            return view('workorder.wobrowse', ['impact' => $impact, 'wottype'=>$wottype,'repairgroup' => $repairgroup,'data' => $data,'user' => $engineer,
                ...
                'repaircode' => $repaircode, 'custrnow' => $custrnow, 'asgroup' => $asgroup]);
        } else {
            toast('Anda tidak memiliki akses menu, Silahkan kontak admin', 'error');
            return back();
        }
...
//dd($kondisi);
    ...
    public function wojoblist(Request $req){ /* blade : workorder.wostart */
        ...
        if (strpos(Session::get('menu_access'), 'WO02') !== false) {
            ...
            if($req->ajax()){
                ...
                return view('workorder.wostart', ['data' => $data,'user' => $engineer,'engine'=>$engineer,'asset1'=>$asset,
                'asset2'=>$asset,'asgroup'=>$asgroup,'custrnow'=>$custrnow]);
            }
    ...
    public function wocloselist(){ /* blade : workorder.woclose */
...
//dd($req->all());
        ...
        return Excel::download(new ViewExport2($wonbr,$status,$asset,$priority,$period,$creator,$engineer,$woper1,$woper2,$wotype),'Work Order.xlsx');
    }
