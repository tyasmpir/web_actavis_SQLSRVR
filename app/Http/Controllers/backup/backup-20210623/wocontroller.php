...
//wo browse
    public function wobrowsemenu($cust){
    ...
    public function openprint(Request $req,$wo){
        ...
        foreach($repair as $repair){
            foreach ($repair as $repair1){
                // dd($repair1);
                if(!in_array($repair1->reppart_desc,$sparepartarray)){
                    array_push($sparepartarray,$repair1->reppart_desc);
                }
