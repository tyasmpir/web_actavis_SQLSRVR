                ...
                for($i = 0; $i<$repairlen; $i++){
                    ...
                    for($i5 = 0; $i5 < $countdb1; $i5++){  
                        ...
                        $arraydetsgrp = array([
                            'wo_dets_nbr'       => $req->c_wonbr,
                            'wo_dets_rc'        => $rg,
                            'wo_dets_sp'        => $req->spm4[$i][$i5],
                            'wo_dets_sp_qty'    => $req->qty4[$i][$i5],
                            'wo_dets_ins'       => $req->insm4[$i][$i5],
                            'wo_dets_rep_hour'  => $req->rph4[$i][$i5],
                            'wo_dets_standard'  => $req->std4[$i][$i5],
                            'wo_dets_flag'      => $req->group4[$i][$i5],
                            'wo_dets_created_at'=> Carbon::now('ASIA/JAKARTA')->toDateTimeString(),
                        ]);
