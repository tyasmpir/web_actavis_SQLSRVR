...
//wo browse
    ...
    public function geteditwo(Request $req){
            ...
            $data = DB::table('wo_mstr')
                ->selectRaw('wo_nbr,wo_repair_type,wo_repair_group,xxrepgroup_nbr,xxrepgroup_desc,wo_status,asset_desc,wo_approval_note,wo_creator,wo_reject_reason,wo_priority,wo_dept,dept_desc,wo_note,wo_sr_nbr,wo_status,wo_asset,asset_desc,wo_schedule,wo_duedate,wo_engineer1 as woen1,wo_engineer2 as woen2, wo_engineer3 as woen3,wo_engineer4 as woen4,wo_engineer5 as woen5,u1.eng_desc as u11,u2.eng_desc as u22, u3.eng_desc as u33, u4.eng_desc as u44, u5.eng_desc as u55, wo_mstr.wo_failure_code1 as wofc1, wo_mstr.wo_failure_code2 as wofc2, wo_mstr.wo_failure_code3 as wofc3, fn1.fn_desc as fd1, fn2.fn_desc as fd2, fn3.fn_desc as fd3,r1.repm_desc as r11,r2.repm_desc as r22,r3.repm_desc as r33,r1.repm_code as rr11,r2.repm_code as rr22,r3.repm_code as rr33, wo_finish_date,wo_finish_time,wo_repair_hour')
        ...
        if($statusrepair->wo_repair_type == 'group'){
            ...
            for($i = 0; $i<count($arrayrepaircode);$i++){
                ...
                $repair[$i] = DB::table('rep_master')
                                ->join('ins_group','rep_master.repm_ins','ins_group.insg_code')
                                ->join('ins_mstr','ins_group.insg_ins','ins_mstr.ins_code')
                                // ->join('sp_group','ins_mstr.ins_part','sp_group.spg_code')
                                ->join('sp_mstr','ins_mstr.ins_code','sp_mstr.spm_code')
                                // ->join('tool_mstr','ins_mstr.ins_tool','tool_mstr.tool_code')
                                ->where('rep_master.repm_code','=',$arrayrepaircode[$i])
                                ->groupby('ins_mstr.ins_code')
                                ->orderBy('repm_ins','asc')
                                ->orderBy('insg_code','asc')
