...
//dd($ytdwopm);
        return view("home", compact('arrayname','countwosr','countwoauto','countwodirect','countwoother','topheal','users','invdx2','invdx1','invdx3','invdx4', 'invbr1','invbr2','invbr3','invbr4','invbr5','invwo1','invwo2','invwo3','invwo4','topprob','dataasset','opensr',
            "countwomonth","countwoopen","countwostart","countwofinish","bulan","ytdwo","hourwo","hourpm",
            "countwopmmonth","countwopmopen","countwopmstart","countwopmfinish","ytdwopm"));   
    }
