...
class UserChartController extends Controller
{
    ...
    //dd($req->all());
        ...
        $datawo = DB::table('wo_mstr')
                ->select('wo_nbr','wo_status','wo_schedule','wo_engineer1', 'wo_engineer2', 'wo_engineer3', 'wo_engineer4', 'wo_engineer5','wo_asset',
                    'asset_desc','wo_sr_nbr','wo_duedate','wo_failure_code1','wo_failure_code2','wo_failure_code3','wo_creator')
        ...
        return view('report.engsch',compact('skrg','hari','kosong','bulan','datawo','dataeng','fotoeng','engcode','datafn'));
    }
