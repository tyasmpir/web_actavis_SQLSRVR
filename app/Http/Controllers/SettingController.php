    ...
    public function createasset(Request $req)
    {
        ...
        if ($cekData->count() == 0) {
            ...
            ->insert([
                ...
                'asset_cal'         => $req->t_cal,
                'asset_tolerance'   => $req->t_tolerance == NULL ? 0 : $req->t_tolerance,
...
// dd($req->all());
        ...
        ->update([
            ...
            'asset_last_mtc'    => $req->te_lastmtc,
            'asset_last_usage'  => $req->te_lastusage,
            'asset_last_usage_mtc' => $req->te_lastusagemtc,
            'updated_at'        => Carbon::now()->toDateTimeString(),
            'edited_by'         => Session::get('username'),
        ]);
