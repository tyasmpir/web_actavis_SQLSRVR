...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Mar 2021 pada 04.12
...
CREATE TABLE `asset_mstr` (
  ...
  `asset_prc_price` decimal(11,2) NOT NULL,
...
INSERT INTO `asset_mstr` (`ID`, `asset_code`, `asset_desc`, `asset_site`, `asset_loc`, `asset_um`, `asset_sn`, `asset_prc_date`, `asset_prc_price`, `asset_type`, `asset_group`, `asset_failure`, `asset_measure`, `asset_supp`, `asset_meter`, `asset_cal`, `asset_last_usage`, `asset_last_usage_mtc`, `asset_last_mtc`, `asset_note`, `created_at`, `updated_at`) VALUES
(2, 'WVVDFE', 'WAE', '10-300', 'RAK2', 'DFSADF', 'DFASFSF', '2021-03-06', '21312312.00', 'MAC3', 'B', 0, 'F', 'S1001', 123123, 'SDFSDF', NULL, NULL, NULL, 'SFDSF', 2021, 2021),
...
INSERT INTO `eng_mstr` (`ID`, `eng_code`, `eng_desc`, `eng_birth_date`, `eng_active`, `eng_join_date`, `eng_rate_hour`, `eng_skill`, `eng_email`, `eng_photo`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `ins_mstr` (`ID`, `ins_code`, `ins_desc`, `created_at`, `updated_at`) VALUES
(1, '1', 'periksa kondisi sekitar', '2021-03-07', '2021-03-13'),
...
(9, 'ins', 'periksa kerusakan', '2021-03-13', '2021-03-13'),
...
CREATE TABLE `roles` (
  `role_code` varchar(24) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `roles` (`role_code`, `role_desc`, `menu_access`, `created_at`, `updated_at`) VALUES
...
CREATE TABLE `users` (
  ...
  `role_user` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  `site` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `users` (`id`, `username`, `name`, `email_user`, `role_user`, `site`, `password`, `session_id`, `created_at`, `updated_at`) VALUES
(1, 'admin', 'Andrew Conan', 'abc@admin.com', 'ADM', 'R0012', '$2y$10$bjR2ziZdk19qyyqwaSVmVO6RLe24UozXtZNzAKDa3liKS8EuWMv5S', 'C7Kh1ThANUHqRanfQLL0hwkYxKYGAb2G7IljeCi9', '2020-08-12 20:39:30', '2021-03-13 13:23:46'),
